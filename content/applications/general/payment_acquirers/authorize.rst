...
.. important::
   ...
   *Test Mode*. We recommend doing this on a test Odoo database, rather than on your main database.
   If you set Test Mode on Odoo and use an authorize.net account instead of a sandbox.authorize.net
   account, it will result in the following error: *The merchant login ID or password is invalid or
